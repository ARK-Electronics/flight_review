...
if os.environ.get('SMTP_SERVER'):
    email_config['smtpserver'] = os.environ.get('SMTP_SERVER').strip()
if os.environ.get('EMAIL_SENDER'):
    email_config['sender'] = os.environ.get('EMAIL_SENDER').strip()
...
if os.environ.get('SENDLAYER_API_KEY'):
    email_config['sendlayer_api_key'] = os.environ.get('SENDLAYER_API_KEY').strip()
...
__MAPBOX_API_ACCESS_TOKEN = os.environ.get(
    'MAPBOX_API_ACCESS_TOKEN',
    _conf.get('general', 'mapbox_api_access_token'))
__CESIUM_API_KEY = os.environ.get(
    'CESIUM_API_KEY', _conf.get('general', 'cesium_api_key'))
...
try:
    ...
    __XAI_MODEL = os.environ.get('XAI_MODEL', 'grok-4.6')
