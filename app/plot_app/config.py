...
__MAPBOX_API_ACCESS_TOKEN = os.environ.get('MAPBOX_API_ACCESS_TOKEN', _conf.get('general', 'mapbox_api_access_token'))
__CESIUM_API_KEY = os.environ.get('CESIUM_API_KEY', _conf.get('general', 'cesium_api_key'))
