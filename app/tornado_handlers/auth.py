        ...
        try:
            ...
            if approved:
                ...
                if send_approval_email(
                    ...
                    msg += ("Registration successful, but failed to notify "
            ...
            traceback.print_exc()
            self.render_jinja(
                'register.html', error=f"Error: {str(e)}", message=None)
        finally:
            if con:
                con.close()
        ...
        try:
            ...
            if row:
                ...
                if send_reset_password_email(email, username, reset_url):
                    ...
                    self.render_jinja(
                        'forgot_password.html',
                        error="Failed to send email.", message=None)
            else:
            ...
            if row:
                ...
                if time.time() < expiration:
                    ...
                    cur.execute(
                        ...
                        "ResetTokenExpiration=0 WHERE Username=?",
